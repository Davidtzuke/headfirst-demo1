...
export function FoundersBanner({ className }: FoundersBannerProps) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto flex items-center justify-center py-6 px-4",
        className
      )}
    >
      <motion.div 
        className="relative flex items-center gap-8 rounded-2xl border border-white/20 bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-md px-8 py-4 shadow-xl"
        whileHover={{ 
          scale: 1.01,
        }}
      ...
      >
        ...
        <div className="relative flex items-center gap-3 text-sm">
          ...
          <span className="font-semibold text-foreground bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent dark:from-blue-400 dark:to-purple-400">
            Meet the Founders
          </span>
        </div>
        ...
        <div className="relative flex items-center gap-6">
          {founders.map((founder, index) => (
            <motion.a
              ...
              className="group relative flex items-center gap-3 rounded-xl bg-gradient-to-r from-white/10 to-white/5 px-5 py-3 text-sm backdrop-blur-sm border border-white/10 hover:border-white/30 transition-all duration-200"
            ...
            >
              {/* Founder avatar */}
              <motion.div
                className="h-8 w-8 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold text-xs shadow-md"
                animate={{
              ...
              <motion.div
                ...
                transition={{ duration: 0.2 }}
              >
                <span className="font-semibold text-foreground group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200">
                  {founder.name}
                </span>
                <motion.div
                  animate={{
